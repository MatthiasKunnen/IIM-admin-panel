...
class ValidatedCustomTextField<E> extends CustomTextField implements ValidatedFieldInterface<E> {
...
class ValidatedCustomPasswordField<E> extends CustomPasswordField implements ValidatedFieldInterface<E> {
    private final ValidationManager<E> validationManager;
...
interface ValidatedFieldInterface<E> {
